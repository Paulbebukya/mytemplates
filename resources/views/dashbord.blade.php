                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <img alt="" class="rounded-circle" src="img/profile_small.jpg">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages dropdown-menu-right">
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a class="dropdown-item float-left" href="profile.html">
                                    <img alt="" class="rounded-circle" src="img/profile.jpg">
                                </a>
                                <div class="media-body ">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div>
                                            <div class="feed-activity-list">
                                                ...
                                                <div class="feed-element">
                                                    <a class="float-left" href="profile.html">
                                                        <img alt="" class="rounded-circle" src="img/a2.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                ...
                                                <div class="feed-element">
                                                    <a class="float-left" href="profile.html">
                                                        <img alt="" class="rounded-circle" src="img/a3.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="float-right">2h ago</small>
                                                ...
                                                <div class="feed-element">
                                                    <a class="float-left" href="profile.html">
                                                        <img alt="" class="rounded-circle" src="img/a5.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="float-right">2h ago</small>
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="" class="rounded-circle message-avatar" src="img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="" class="rounded-circle message-avatar" src="img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="" class="rounded-circle message-avatar" src="img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="" class="rounded-circle message-avatar" src="img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="" class="rounded-circle message-avatar" src="img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="" class="rounded-circle message-avatar" src="img/a7.jpg">
                                    </div>
                                    <div class="media-body">
