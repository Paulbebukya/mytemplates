...
<div class="wrapper wrapper-content" style="max-height:90vh; overflow:auto">
    <div class="row">
        <div class="col-lg-12">
            <div class="row">
                <div class="col-lg-4">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <p>
                                        ...
                                        belive that. Lorem Ipsum is simply dummy text of the
                                ...
                                <li class="list-group-item">
                                    <p>
                                        <a class="text-info" href="#">@Kevin Smith</a> Lorem
                                        ipsum unknown printer took a galley
                                    </p>
                ...
                <div class="col-lg-4">
                    <div class="ibox">
                        ...
                        <div class="ibox-content ibox-heading">
                            ...
                            <small><i class="fa fa-map-marker"></i> Meeting is on 6:00am.
                                Check your schedule to see detail.</small>
                        </div>
